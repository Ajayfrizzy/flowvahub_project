      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-pink-50 rounded-3xl p-10 text-left relative overflow-hidden min-h-[280px]">
            <h3 className="text-lg sm:text-xl font-bold text-black mb-4 leading-snug">
              Engage an active community of tech enthusiasts
            </h3>
            <p className="text-xs sm:text-sm text-gray-600 mb-6 leading-relaxed">
              Connect with users who are actively discovering and engaging with tools every single day.
            </p>
          ...
          <div className="bg-purple-500 rounded-3xl p-10 text-left relative overflow-hidden min-h-[280px]">
            ...
            <p className="text-purple-100 text-xs sm:text-sm mb-8 leading-relaxed">
              Stand out with special discounts, exclusive access to premium features, and limited-time offers.
            </p>
          ...
          <div className="bg-yellow-100 rounded-3xl p-10 text-left relative overflow-hidden min-h-[280px]">
            ...
            <p className="text-gray-700 text-xs sm:text-sm mb-8 leading-relaxed">
              Get featured across our platform to thousands of users. Elevate your brand through strategic placements and more.
            </p>
          ...
          <div className="bg-black rounded-3xl p-10 text-left relative overflow-hidden min-h-[280px]">
            ...
            <p className="text-gray-300 text-xs sm:text-sm mb-10 leading-relaxed">
              Track real results with comprehensive analytics. See exactly how your brand performs and grows.
            </p>
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              <div>
                <div className="text-4xl sm:text-5xl font-semibold text-white mb-1">30,000+</div>
